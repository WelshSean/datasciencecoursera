...
pa <- pa + ggtitle("Fatalities Caused by Severe Weather")
...
pb <- pb + ggtitle("Injuries Caused by Severe Weather")
...
pc <- pc + ggtitle("Property Damage Caused by Severe Weather")
...
pd <- pd + ggtitle("Property Damage Caused by Severe Weather")
