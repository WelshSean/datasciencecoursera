...
StormData[TstmWind,"EVTYPE"] <- "Thunderstorms"
## Snow
...
StormData[HighWinds,"EVTYPE"] <- "High Winds"
## Rain
...
StormData[ExtStorm,"EVTYPE"] <- "Extreme Storm"
## Floods
...
## Other
Other <- !(grepl("Thunderstorms|Snow|High Winds|Rain|Hail|Extreme Storm|Floods|Heat|Cold Spell| High Seas| Dry Spell|Wet Spell", StormData$EVTYPE, ignore.case=T))
