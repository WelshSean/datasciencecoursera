...
The values of the mean of mpg for automatic (`r round(mean(mtcars[ mtcars$am == 0, ]$mpg), digits=1)`) and manual (`r round(mean(mtcars[ mtcars$am == 1, ]$mpg), digits=1)`) cars suggests that cars with a manual transmission have a `r round((mean(mtcars[ mtcars$am == 1, ]$mpg) - mean(mtcars[ mtcars$am == 0, ]$mpg))/mean(mtcars[ mtcars$am == 0, ]$mpg) *100, digits=1)`% higher mpg value than automatic vehicles.
...
## Figure 3: Boxplot showing how mpg depends on am in the mtcars dataset
